	...
	function upload($file,$dir,$file_name='',$file_size=20480000,$ext=array('jpg','png','gif','ico')) {
		...
		if (!empty($_FILES[$file]['error'])) {
			switch($_FILES[$file]['error']){
				case '1':$error = '超過php.ini允許的大小';break;
				case '2':$error = '超過表單允許的大小';break;
				case '3':$error = '圖片只有部分被上傳';break;
				case '4':$error = '請選擇圖片';break;
				case '6':$error = '找不到臨時目錄';break;
				case '7':$error = '寫檔案到硬碟出錯';break;
