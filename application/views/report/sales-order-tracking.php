...
查詢）</p>
              ...
              <li id="status-wrap">
                ...
                <label class="chk"><input type="checkbox" value="0" name="status" />未出庫</label>
                <label class="chk"><input type="checkbox" value="1" name="status" />部分出庫</label>
                <label class="chk"><input type="checkbox" value="2" name="status" />已出庫</label>
              </li>
              <li>
...
="ui-btn fl" id="btn-export">導出</a></div>
	...
	<div class="ui-print">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">銷售訂單跟蹤表</div>
