...
<div class="mod-report">
  <div class="search-wrap" id="report-search">
    <div class="s-inner cf">
          ...
          <div class="con">
            ...
            <ul class="filter-list" id="more-conditions">
              ...
              <li style="height:60px; ">
                ...
                <p style="color:#999; padding:3px 0 0 0; ">（可用,分割多個編碼如1001,1008,2001，或直接輸入編碼段如1001--1009查詢）</p>
              </li>
              <li>
      ...
      <div class="fr"><a href="#" class="ui-btn ui-btn-sp fl" id="btn-export">導出</a></div>
    </div>
  </div>
  ...
  <div class="ui-print">
    ...
    <div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">銷售彙總表（按商品）</div>
