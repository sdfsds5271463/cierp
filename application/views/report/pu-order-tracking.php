...
查詢）</p>
              ...
              <li id="status-wrap">
                <label class="tit">狀態:</label>
                <label class="chk"><input type="checkbox" value="0" name="status" />未入庫</label>
                <label class="chk"><input type="checkbox" value="1" name="status" />部分入庫</label>
                <label class="chk"><input type="checkbox" value="2" name="status" />已入庫</label>
              </li>
            </ul>
...
="ui-btn fl" id="btn-export">導出</a></div>
	...
	<div class="ui-print">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">採購訂單跟蹤表</div>
