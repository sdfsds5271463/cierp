...
<div class="hd cf">
	<ul class="ui-tab" id="tab">
		<li class="cur tabItem">基礎資料</li>
        <li class="tabItem">庫存預警</li>
        <li class="tabItem">高級</li>
        <li class="tabItem">期初設定</li>
...
<div id="tabContent">
            ...
            <form id="manage-form" action="">
                ...
                <div id="jdInfo" class="liGroup cf dn">
                    ...
                    <ul class="mod-form-rows base-form cf">
                        ...
                        <li class="row-item">
                            <div class="label-wrap"><label for="length">長(mm)</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="length" id="length"></div>
                        </li> 
                        <li class="row-item">
                            <div class="label-wrap"><label for="width">寬(mm)</label></div>
                ...
                <div class="liGroup cf">
                    ...
                    <ul class="mod-form-rows base-form cf">
                        ...
                        <li class="row-item">
                            <div class="label-wrap"><label for="purchasePrice">預計採購價</label></div>
                    ...
                    <ul class="mod-form-rows">
                        <li class="row-item pb0">
                            <div class="ctn-wrap" style="line-height: normal;"><textarea name="" id="note" class="ui-input ui-input-ph">新增備註資訊</textarea></div>
                        </li>
                    </ul>
                </div>
            </form>
    ...
    <div class="manage-wrapper dn">
        <div id="manage-wrap" class="manage-wrap">
            <div class="cf">
                <!-- <h3>庫存預警</h3> --><label id='warning'><input type="checkbox">啟用分倉預警</label><label id='warningSku' class="dn"><input type="checkbox">根據屬性設定</label>
                <ul class="mod-form-rows base-form cf">
                    <li class="row-item">
                        <div class="label-wrap"><label for="minInventory">最低庫存</label></div>
                        <div class="ctn-wrap"><input type="text" class="ui-input" name="minInventory" id="minInventory"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="maxInventory">最高庫存</label></div>
        ...
        <div id="manage-wrap" class="manage-wrap">
            <div class="cf">
                ...
                <div class="row-item serField dn">
                    <label for="isSerNum">啟用序列號</label>
