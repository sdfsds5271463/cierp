    ...
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			...
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="receiveFunds">期初應付款</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="receiveFunds" id="receiveFunds"></div>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="periodReceiveFunds">期初預付款</label></div>
    			...
    			<li class="row-item last">
    				<div class="label-wrap"><label for="taxRate">增值稅稅率</label></div>
