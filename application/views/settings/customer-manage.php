...
.mod-form-rows .row-item {padding-bottom: 15px;margin-bottom: 0;}/*相容IE7 ，重寫common的演示*/
    	...
    	<form id="manage-form" action="">
    		...
    		<ul class="mod-form-rows">
    			<li class="row-item pb0">
    				<!-- <div class="label-wrap"><label for="note">備註</label></div> -->
    				<div class="ctn-wrap"><textarea name="" id="note" class="ui-input ui-input-ph">新增備註資訊</textarea></div>
    			</li>
    		</ul>
    	</form>
    </div>
