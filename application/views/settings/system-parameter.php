  ...
  <div id="para-wrapper">
    <div class="para-item">
      ...
      <ul class="mod-form-rows" id="establish-form">
        ...
        <li class="row-item">
          <div class="label-wrap">
            <label for="companyTel">公司電話：</label>
          </div>
          <div class="ctn-wrap">
        ...
        <li class="row-item">
          <div class="label-wrap">
            <label for="companyFax">公司傳真：</label>
          </div>
          <div class="ctn-wrap">
        ...
        <li class="row-item">
          <div class="label-wrap">
            <label for="startDate">啟用時間：</label>
          </div>
          <div class="ctn-wrap">
...
<!--        <li class="row-item">
        ...
        <li class="row-item">
          <div class="label-wrap">
            <label for="valMethods">存貨計價方法：</label>
          </div>
          <div class="ctn-wrap">
        ...
        <li class="row-item">
          <div class="label-wrap">
            <label for="requiredCheckStore">是否檢查負庫存：</label>
          </div>
          <div class="ctn-wrap">
    ...
    <div class="btn-wrap"> <a id="save" class="ui-btn ui-btn-sp">儲存</a> </div>
  </div>
</div>
