...
<div class="wrapper">
    <div class="mod-toolbar-top">
       ...
       <span class="tit" id="shareInfo" style="display:none;">該賬套主服務最多支援<strong id="totalUser"></strong>使用者共同管理，已共享<strong id="usedTotal"></strong>人，剩餘<strong id="leftTotal"></strong>。</span>
    </div>    
    <div class="grid-wrap">
      <table id="grid">
      </table>
  ...
  (function($){
    ...
    function initGrid(){
      $('#grid').jqGrid({
        ...
        colNames:['使用者', '真實姓名', '公司','功能授權','數據授權','啟用授權'],
        colModel:[
    ...
    function settingDataFormatter(val, opt, row) {
		if (row.admin || row.share === false) {
			...
			return '<div class="operating" data-id="' + row.userId + '"><a class="ui-icon ui-icon-pencil" title="詳細設定授權資訊" href="../settings/authority_setting_data?userName=' + row.userName + '"></a></div>';
		}
    };
