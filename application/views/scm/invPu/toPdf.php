...
<head>
<title><?php echo $transType==150501 ? '購貨單' :'購貨退貨單'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'細明體'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150501 ? '購貨單' :'購貨退貨單'?></td>
			</tr>
		</table>	
		...
		<table width="800" align="center">
			<tr height="15" align="left" >
				<td width="250" style="font-family:'細明體'; font-size:14px;height:20px;">供應商：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="10" ></td>
				<td width="150" >單據日期：<?php echo $billDate?></td>
				<td width="250" >單據編號：<?php echo $billNo?></td>
				<td width="60" >幣別：RMB</td>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
				...
				<tr style="height:20px">
					...
					<td width="80" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;" align="center">購貨單價</td>	
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;" align="center">購貨金額</td>	
			   ...
			   ?>
				<tr style="height:20px">
				   <td width="30"  style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'細明體'; font-size:12px;" align="center"><?php echo $row['i']?></td>
				...
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'細明體'; font-size:12px;">
					...
					<td width="30" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'細明體'; font-size:12px;" align="center"><?php echo $m?></td>
					<td width="220" ></td>
				...
				<tr target="id">
				    <td colspan="9" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;">合計 金額大寫： <?php echo str_num2rmb(abs($totalAmount))?> </td> 
				</tr>
				<?php }?>
		</table>
		...
		<table  width="800" align="center">
		  <tr height="25" align="left">
				<td align="left" width="200" style="font-family:'細明體'; font-size:14px;height:25px;">折扣額：<?php echo str_money(abs($disAmount),2)?></td>
				<td width="200" style="font-family:'細明體'; font-size:14px;height:25px;">折扣後金額：<?php echo str_money(abs($amount),2)?></td>
				<td width="200" style="font-family:'細明體'; font-size:14px;height:25px;"><?php echo $transType==150501 ? '本次付款：' :'本次退款：'?><?php echo str_money(abs($rpAmount),2)?></td>
				<td width="200" style="font-family:'細明體'; font-size:14px;height:25px;">本次欠款：<?php echo str_money(abs($arrears),2)?></td>
				<td width="50" style="font-family:'細明體'; font-size:14px;height:25px;"></td>
		...
		<table  width="800" align="center">
		  <tr height="25" align="left">
				<td align="left" width="960" style="font-family:'細明體'; font-size:14px;height:25px;">備註： <?php echo $description?></td>
				<td width="0" ></td>
				<td width="0" ></td>
				<td width="0" ></td>
				<td width="0" ></td>
		...
		<table  width="800" align="center">
			<tr height="25" align="left">
				<td align="left" width="250" style="font-family:'細明體'; font-size:14px;height:25px;">制單人：<?php echo $userName?> </td>
				<td width="250" style="font-family:'細明體'; font-size:14px;height:25px;">收貨人簽字：____________</td>
				<td width="250" style="font-family:'細明體'; font-size:14px;height:25px;">供應商簽字：____________</td>
				<td width="100" ></td>
				<td width="100" ></td>
