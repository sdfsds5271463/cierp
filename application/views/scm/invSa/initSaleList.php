...
<div class="wrapper">
  <div class="mod-search cf">
    <div class="fl">
      <ul class="ul-inline">
        <li>
          <input type="text" id="matchCon" class="ui-input ui-input-ph" value="請輸入單據號或客戶名或序列號或備註">
        </li>
        <li>
          <label>日期:</label>
        ...
        <li><a class="mrb more" id="moreCon">(高級搜索)</a><a class="ui-btn" id="search">查詢</a><!--<a class
="ui-btn ui-btn-refresh" id="refresh" title="重新整理"><b></b></a>--></li>
      </ul>
    </div>
    <div class="fr"><a class="ui-btn ui-btn-sp" id="add">新增</a><a class="ui-btn" id="print" target="_blank"
 href="javascript:void(0);">列印</a><!-- a class="ui-btn" id="import" target="_blank" href="javascript
:void(0);">匯入</a--><a class="ui-btn" id="export" target="_blank" href="javascript:void(0);">導出</a><a
 class="ui-btn dn" id="audit">審覈</a><a class="ui-btn" id="reAudit">反審覈</a></div>
  </div>
