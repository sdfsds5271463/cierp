...
<head>
<title><?php echo $transType==150601 ? '銷貨單' :'銷貨退貨單'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'細明體'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150601 ? '銷貨單' :'銷貨退貨單'?></td>
			</tr>
		</table>	
		...
		<table width="800" align="center">
			<tr height="15" align="left">
				...
				<td width="140" style="font-family:'細明體'; font-size:12px;height:20px;">單據編號：<?php echo $billNo?></td>
				
 
			</tr>
			<tr height="15" align="left">
				<td width="120" style="font-family:'細明體'; font-size:12px;height:20px;">聯繫人：<?php echo $udf01?> </td>
				<td width="220" style="font-family:'細明體'; font-size:12px;height:20px;">地址：<?php echo $udf03?></td>
				<td width="120" style="font-family:'細明體'; font-size:12px;height:20px;">電話：<?php echo $udf02?></td>
                <td width="140" style="font-family:'細明體'; font-size:12px;height:20px;">幣別：RMB</td>
			</tr>
		</table>	
		...
		<table width="900" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			<tr style="height:20px">
					...
					<td width="160" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;" align="center">商品</td> 
					...
					<td width="30" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;" align="center">數量</td>
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:14px;height:15px;" align="center">備註</td>	
				</tr>
		       <?php 
			   $i = ($t-1)*$num + 1;
			   ...
			   ?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'細明體'; font-size:12px;">
				   <td width="30"  align="center"><?php echo $row['i']?></td>
					<td width="160" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'細明體'; font-size:12px;"><?php echo $row['goods'];?></td>
					<td width="30" align="center" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'細明體'; font-size:12px;"><?php echo $row['mainUnit']?></td>
				...
				<tr target="id">
				    <td colspan="10" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'細明體'; font-size:12px;height:15px;">合計 金額大寫： <?php echo str_num2rmb(abs($totalAmount))?> </td> 
				</tr>
				<?php }?>
		</table>
		...
		<table  width="800" align="center">
		  <tr height="15" align="left">
				<td align="left" width="200" style="font-family:'細明體'; font-size:12px;height:25px;">折扣額：<?php echo str_money(abs($disAmount),2)?></td>
				<td width="150" style="font-family:'細明體'; font-size:12px;height:25px;">折扣後金額：<?php echo str_money(abs($amount),2)?></td>
				<td width="150" style="font-family:'細明體'; font-size:12px;height:25px;"><?php echo $transType==150601 ? '本次收款：' :'本次退款：'?> <?php echo str_money(abs($rpAmount),2)?></td>
				<td width="150" style="font-family:'細明體'; font-size:12px;height:25px;">本次欠款：<?php echo str_money(abs($arrears),2)?></td>
				<td width="50" ></td>
