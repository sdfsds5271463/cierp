...
<div class="wrapper">
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        <dd class="pct35">
          <a id="chooseTemp" class="ui-btn">選擇模板</a>
          <a id="saveTemp" class="ui-btn">存為模板</a>
        <dd class="pct30 tc">
          <label>單據日期：</label>
    ...
    <div class="grid-wrap">
      <h5><label class="r"><input type="checkbox" checked="checked" value="1" class="vm" id="isAuto"> 自動分攤</label>組合件：</h5>
      <table id="fixedGrid">
      </table>
      <h5>子件：</h5>
      <table id="grid">
