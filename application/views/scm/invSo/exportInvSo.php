		...
		<table width="1500px" class="list"  border="1">
			...
			<tbody>
				...
				<tr target="id">
					...
					<td rowspan="<?php echo $n?>" ><?php echo intval($row['billStatus'])==2 ? '全部出庫' :'未出庫'?></td>
