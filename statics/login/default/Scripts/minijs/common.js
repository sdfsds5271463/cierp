...
function getRadioValue(radioname,isrequire){
		...
		if(isrequire == "1"){
			$("div[name="+radioname+"]").parent().siblings(".stxtBoxUlLiTip").html('<div class="errorTip">必選</div>');
			return false; 	
		}
}
...
function GoDateFun(id) {
    ...
    setTimeout(function() {
        ...
        //因為來電頁面使用時間控制元件，避免input衝突，故將明細頁面的手機控制元件改為MobilePhone01
