...
var api = frameElement.api,
	...
	THISPAGE = {
		...
		initDom: function() {
			this.$_matchCon = $("#matchCon").val(queryConditions.skey || "請輸入商品編號或名稱或型號"), this.$_matchCon.placeholder()
		},
		initZtree: function() {
		...
		loadGrid: function() {
			function a(a, b, c) {
				var d = '<div class="operating" data-id="' + c.id + '"><a class="ui-icon ui-icon-search" title="查詢"></a><span class="ui-icon ui-icon-copy" title="商品圖片"></span></div>';
				return d
			}
		...
		addEvent: function() {
			...
			$(".grid-wrap").on("click", ".ui-icon-search", function(a) {
				...
				queryConditions.catId = a.catId, queryConditions.skey = "請輸入商品編號或名稱或型號" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), a.reloadData(queryConditions)
