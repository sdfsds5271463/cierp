var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var c = '<a id="savaAndAdd" class="ui-btn ui-btn-sp">儲存並新增</a><a id="save" class="ui-btn">儲存</a>',
				d = '<a id="add" class="ui-btn ui-btn-sp">新增</a><a href="../scm/invPo/toPdf?action=toPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn">列印</a><a id="edit" class="ui-btn">儲存</a>',
				e = '<a id="add" class="ui-btn ui-btn-sp">新增</a><a href="../scm/invPo/toPdf?action=toPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn">列印</a>',
				f = "",
				g = "",
				h = "150502" == originalData.transType ? "產生退貨單" : "產生購貨單",
				i = '<a id="turn" class="ui-btn ' + (2 == a.billStatus ? "ui-btn-dis" : "ui-btn-sc") + '">' + h + "</a>",
				j = '<a class="ui-btn" id="close">關閉</a>',
				k = '<a class="ui-btn" id="open">開啟</a>';
			billRequiredCheck ? (f = '<a class="ui-btn" id="audit">審覈</a>', g = '<a class="ui-btn" id="reAudit">反審覈</a>') : (d = i + d, this.$_checkName.parent().hide());
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(b) {
				...
				if (b.preventDefault(), Business.verifyRight("PO_CHECK")) {
					...
					d && c.ajaxPost("../scm/invPo/checkInvPo?action=checkInvPo", {
						...
						200 === b.status ? (originalData.id = b.data.id, $("#mark").addClass("has-audit"), a.$_checkName.html(SYSTEM.realName).parent().show(), a.disableEdit(), $("#groupBtn").html(a.btn_turn + a.btn_view + a.btn_reaudit + a.btn_close), "150502" == a.classes.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生購貨單"), parent.Public.tips({
							content: "審覈成功！"
						})) : parent.Public.tips({
							type: 1,
							content: b.msg
				...
				if (b.preventDefault(), Business.verifyRight("PO_CLOSE")) {
					...
					d && c.ajaxPost("../scm/invPo/batchClose?action=batchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").addClass("has-closed'has-closed'"), a.disableEdit(), $("#groupBtn").html(a.btn_view + a.btn_open), "150502" == a.classes.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生購貨單"), parent.Public.tips({
							content: "關閉成功！"
						})) : parent.Public.tips({
							type: 1,
				...
				if (b.preventDefault(), Business.verifyRight("PO_UNCLOSE")) {
					...
					c.ajaxPost("../scm/invPo/rebatchClose?action=rebatchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").removeClass("has-closed"), a.enableEdit(), $("#groupBtn").html((billRequiredCheck ? a.btn_turn : "") + a.btn_edit + a.btn_reaudit + a.btn_close), "150502" == a.classes.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生購貨單"), parent.Public.tips({
							content: "開啟成功！"
						})) : parent.Public.tips({
							type: 1,
				...
				if (b.preventDefault(), $(this).hasClass("ui-btn-dis")) return void parent.Public.tips({
					type: 1,
					content: "該訂單已全部入庫，不能產生購貨單！"
				});
				var c = "購貨單",
					d = "purchase-purchase",
					e = a.classes.getValue();
				if ("150502" == e) var c = "購貨退貨單",
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有上一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invPo/update?action=update", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有下一張了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invPo/update?action=update", {
					id: a.idList[a.idPostion]
				}, function(b) {
