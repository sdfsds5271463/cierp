	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var b = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">儲存並新增</a><a id="save" class="ui-btn">儲存</a>',
				c = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invTf/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">列印</a><a id="edit" class="ui-btn mrb">儲存</a>',
				d = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invTf/toPdf?action=toPdf" target="_blank" id="print" class="ui-btn mrb">列印</a><b></b></a>',
				e = "",
				f = "",
				g = "";
		...
		addEvent: function() {
			...
			this.$_date.bind("keydown", function(a) {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有上一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), a.idPostion && (loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("/scm/invTf.do?action=update", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有下一張了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), a.idPostion && (loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("/scm/invTf.do?action=update", {
					id: a.transfersListIds[a.idPostion]
				}, function(a) {
