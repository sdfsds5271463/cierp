	...
	THISPAGE = {
		...
		manager: {
			...
			makeOrder: function(a) {
				...
				var g = "",
					h = "";
				c.outboundData && (g = '<li><span class="ui-label ui-label-warning" id="out">盤虧單</span></li>'), c.warehouseData && (h = '<li><span class="ui-label ui-label-warning" id="in">盤盈單</span></li>');
				...
				b.pop = $.dialog({
					...
					cancel: function() {
						return $.dialog.confirm("未完善相關出入庫單據會影響本次盤點數據，確定要取消嗎？", function() {
				...
				c.import_dialog = $.dialog({
					...
					ok: function() {
						return b = this.content.$("#file-path"), "" === b.val() ? (parent.Public.tips({
							type: 2,
							content: "請先選擇匯入的檔案！"
						}), !1) : (c.loading = $.dialog.tips("正在匯入數據，請稍候...", 1e3, "loading.gif", !0), this.content.callback(), !1)
					},
					cancel: !0
				})
