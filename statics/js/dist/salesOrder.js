var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var f = '<a id="savaAndAdd" class="ui-btn ui-btn-sp">儲存並新增</a><a id="save" class="ui-btn">儲存</a>',
				g = '<a id="add" class="ui-btn ui-btn-sp">新增</a><a href="../scm/invSo/toPdf?action=toPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn">列印</a><a id="edit" class="ui-btn">儲存</a>',
				h = '<a id="add" class="ui-btn ui-btn-sp">新增</a><a href="../scm/invSo/toPdf?action=toPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn">列印</a>',
				i = "",
				j = "",
				k = "150602" == originalData.transType ? "產生退貨單" : "產生銷貨單",
				l = '<a id="turn" class="ui-btn ' + (2 == a.billStatus ? "ui-btn-dis" : "ui-btn-sc") + '">' + k + "</a>",
				m = '<a class="ui-btn" id="close">關閉</a>',
				n = '<a class="ui-btn" id="open">開啟</a>';
			billRequiredCheck ? (i = '<a class="ui-btn" id="audit">審覈</a>', j = '<a class="ui-btn" id="reAudit">反審覈</a>') : (g = l + g, this.$_checkName.parent().hide());
			var o = '<a class="ui-btn-prev" id="prev" title="上一張"><b></b></a><a class="ui-btn-next" id="next" title="下一張"><b></b></a>';
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(b) {
				...
				if (b.preventDefault(), Business.verifyRight("SO_CHECK")) {
					...
					d && c.ajaxPost("../scm/invSo/checkInvSo?action=checkInvSo", {
						...
						200 === b.status ? (originalData.id = b.data.id, $("#mark").addClass("has-audit"), a.$_checkName.html(SYSTEM.realName).parent().show(), a.disableEdit(), $("#groupBtn").html(a.btn_turn + a.btn_view + a.btn_reaudit + a.btn_close), "150602" == a.classBox.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生銷貨單"), parent.Public.tips({
							content: "審覈成功！"
						})) : parent.Public.tips({
							type: 1,
							content: b.msg
				...
				if (b.preventDefault(), Business.verifyRight("SO_CLOSE")) {
					...
					d && c.ajaxPost("../scm/invSo/batchClose?action=batchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").addClass("has-closed"), a.disableEdit(), $("#groupBtn").html(a.btn_view + a.btn_open), "150602" == a.classBox.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生銷貨單"), parent.Public.tips({
							content: "關閉成功！"
						})) : parent.Public.tips({
							type: 1,
							content: "關閉失敗：" + b.msg[0].msg || ""
						}) : parent.Public.tips({
							type: 1,
							content: b.msg
						})
				...
				if (b.preventDefault(), Business.verifyRight("SO_UNCLOSE")) {
					...
					c.ajaxPost("../scm/invSo/rebatchClose?action=rebatchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").removeClass("has-closed"), a.enableEdit(), $("#groupBtn").html((billRequiredCheck ? a.btn_turn : "") + a.btn_edit + a.btn_audit + a.btn_close), "150602" == a.classBox.getValue() ? $("#turn").html("產生退貨單") : $("#turn").html("產生銷貨單"), parent.Public.tips({
							content: "開啟成功！"
						})) : parent.Public.tips({
							type: 1,
							content: "開啟失敗：" + b.msg[0].msg || ""
						}) : parent.Public.tips({
							type: 1,
							content: b.msg
						})
				...
				if (b.preventDefault(), $(this).hasClass("ui-btn-dis")) return void parent.Public.tips({
					type: 1,
					content: "該訂單已全部入庫，不能產生銷貨單！"
				});
				var c = "銷貨單",
					d = "sales-sales",
					e = a.classBox.getValue();
				if ("150602" == e) var c = "銷貨退貨單",
					d = "sales-salesBack";
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有上一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invSo/update?action=update", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有下一張了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("數據載入中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invSo/update?action=update", {
					id: a.idList[a.idPostion]
				}, function(a) {
