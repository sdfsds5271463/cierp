$(function() {
		...
		h.gridReg("grid", d), d = h.conf.grids.grid.colModel, $("#grid").jqGrid({
			...
			loadComplete: function(a) {
				if (a && 200 == a.status) {
					...
					var f = 250 === a.status ? e ? "沒有滿足條件的結果哦！" : "沒有客戶數據哦！" : a.msg;
					parent.Public.tips({
						type: 2,
						content: f
					})
	...
	var d, e = !1,
		f = {
			...
			del: function(a) {
				$.dialog.confirm("刪除的供應商將不能恢復，請確認是否刪除？", function() {
