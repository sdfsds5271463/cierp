...
var api = frameElement.api,
	...
	THISPAGE = {
		...
		loadGrid: function() {
			...
			$grid.jqGrid({
				url: "../basedata/invlocation?action=list",
				...
				colModel: [{
					...
					width: 100,
					title: !1,
					formatter: THISPAGE.statusFmatter,
					hidden: !0,
					align: "center"
				}],
				cmTemplate: {
		...
		addEvent: function() {
			...
			$("#search").click(function() {
				queryConditions.skey = "請輸入倉庫編號或名稱" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), THISPAGE.reloadData(queryConditions)
