...
var THISPAGE = {
	...
	addEvent: function() {
		...
		$("#search").click(function() {
			queryConditions.salesId = null, queryConditions.matchCon = "請輸入單據號或客戶名或序列號或備註" === a.$_matchCon.val() ? "" : $.trim(a.$_matchCon.val()), queryConditions.beginDate = a.$_beginDate.val(), queryConditions.endDate = a.$_endDate.val(), THISPAGE.reloadData(queryConditions)
			...
			if (a.preventDefault(), Business.verifyRight("SA_ADD")) {
				var b = "銷貨單",
					c = "sales-sales";
				if ("150602" == queryConditions.transType) var b = "銷貨退貨單",
					c = "sales-salesBack";
				parent.tab.addTabItem({
					tabid: c,
					text: b,
