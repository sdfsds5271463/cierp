	...
	THISPAGE = {
		...
		addEvent: function() {
			...
			$("#search").click(function() {
				...
				}) : (queryConditions.beginDate = b, queryConditions.endDate = c, queryConditions.billNo = "請輸入源單編號" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), void THISPAGE.reloadData(queryConditions))
