$(function() {
		...
		var a = Public.setGrid(f, g),
			...
			l = [{
				...
				formatter: function(a, b, c) {
					var d = '<div class="operating" data-id="' + c.id + '"><span class="ui-icon ui-icon-pencil" title="修改"></span><span class="ui-icon ui-icon-trash" title="刪除"></span><span class="ui-icon ui-icon-pic" title="商品圖片"></span></div>';
					return d
				},
				title: !1
			}, {
	...
	function c() {
		$_matchCon = $("#matchCon"), $_matchCon.placeholder(), $("#search").on("click", function(a) {
			a.preventDefault();
			var b = "按商品編號，商品名稱，規格型號等查詢" === $_matchCon.val() ? "" : $.trim($_matchCon.val()),
	...
	var d = (parent.SYSTEM, Number(parent.SYSTEM.qtyPlaces), Number(parent.SYSTEM.pricePlaces)),
		...
		h = {
			...
			del: function(a) {
				$.dialog.confirm("刪除的商品將不能恢復，請確認是否刪除？", function() {
